...
urlpatterns = patterns('',
    ...
    url(r'^eval_click/$', views.eval_click, name='eval_click'),
    url(r'^approve_applicants_index/$', views.approve_applicants_index, name='approve_applicants_index'),
    url(r'^approve/(?P<applicant_id>\d+)/$', views.approve, name='approve'),
    url(r'^approve_click/$', views.approve_click, name='approve_click'),
