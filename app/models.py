...
class Evaluation(models.Model):
    ...
    criteria_1_rating = models.IntegerField(null=True, blank=True, label='The applicant has a working understanding of social-, racial-, or economic justice.')
    criteria_2_rating = models.IntegerField(null=True, blank=True, label='The applicant demonstrates activism or community involvement in racial-, social-, or economic-justice projects.')
    criteria_3_rating = models.IntegerField(null=True, blank=True, label='The applicant displays sufficient professionalism to be successful in a professional environment post-Fellowship.')
    criteria_4_rating = models.IntegerField(null=True, blank=True, label='The applicant demonstrates values of mentorship and leadership.')
    criteria_5_rating = models.IntegerField(null=True, blank=True, label='The applicant shows an appreciation of the value associated with the opportunity.')
    criteria_6_rating = models.IntegerField(null=True, blank=True, label='The applicant identifies as a woman or person of color.')
    criteria_7_rating = models.IntegerField(null=True, blank=True, label='The applicant demonstrates an analytical approach to problem solving.')
